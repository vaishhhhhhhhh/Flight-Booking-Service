...
public class FlightServiceImpl implements FlightService{
    ...
    public FlightsDTO updateFlight(Integer id, FlightsDTO flightsDTO) {
        ...
        if (optionalFlights.isPresent()) {
            ...
            flightsSave.setDepartureDate(flightsDTO.getDepartureDate() != null ? flightsDTO.getDepartureDate() : flightsSave.getDepartureDate());
            flightsSave.setArrivalDate(flightsDTO.getArrivalDate() != null ? flightsDTO.getArrivalDate() : flightsSave.getArrivalDate());

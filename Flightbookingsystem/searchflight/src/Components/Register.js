...
function Register() {
    ...
    const password_error = inputs.verifyuserPassword !== inputs.userPassword
                    ...
                    <Stack alignItems='center' direction='column' spacing={2}>
                        ...
                        <Stack alignItems='center' direction='row' spacing={2}>
                            <FormControl sx={{ width: 'auto' }} variant="outlined">
                                <InputLabel htmlFor="outlined-adornment-password">userPassword</InputLabel>
                                <OutlinedInput
                                    id="outlined-adornment-password"
                                    required
                                    fullWidth
                                    type={inputs.showPassword ? 'text' : 'userPassword'}
                            ...
                            <FormControl sx={{ width: 'auto' }} variant="outlined">
                                ...
                                <OutlinedInput
                                    ...
                                    fullWidth
                                    type='userPassword'
                                    value={inputs.verifyuserPassword}
                                    onChange={handleChange('verifyuserPassword')}
                                    endAdornment={
                                    <InputAdornment position="end">
                                        {password_error ? <ClearRoundedIcon color='error' /> : <CheckRoundedIcon color='success'/>}
                                    </InputAdornment>
                                    }
                                    label="verifyuserPassword"
                                />
                            </FormControl>
                        </Stack>
